        ...
        <el-card class="box-card">
            ...
            <div class="content">
                ...
                <div class="mid">
                    <div class="question">
                        <div class="topic">
                            <h2>哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈</h2>
                        </div>
                        <div class="option">
                            <el-radio-group v-model="radio">
                                <el-radio v-for="option in options" :key="option.value" :label="option.value" size="large" border class="vertical-option">
                                    {{ option.label }}
                                </el-radio>
                            </el-radio-group>
                        </div>
