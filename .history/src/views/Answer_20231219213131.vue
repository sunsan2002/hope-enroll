...
import { readExcel, Question } from '../utils/read'; 
/**
* 仓库
*/
...
const filePath = 'C:/Users/86183/Desktop/测试题/file.xlsx';

onMounted(() => {
  questions.value = readExcel(filePath);
  console.log(questions.value); // You can do something with the questions here
});
const finish = () =>{
