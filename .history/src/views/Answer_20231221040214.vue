...
import { ref, reactive, toRefs, onBeforeMount, onMounted, watchEffect, computed } from 'vue';import { useStore } from 'vuex';
...
onMounted(() => {
    ...
    for(let i=0; i<option.value[0].length; i++){
        options[i].label = option.value[0].values
    }
})
