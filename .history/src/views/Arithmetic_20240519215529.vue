 ...
 * @LastEditTime: 2024-05-19 21:52:13
...
<template>
    <div class="body">
        <el-row :gutter="26">
            <el-col :span="15">
                <el-carousel class="flag1" v-observe="'active1'" indicator-position="outside"  :autoplay="true" :interval='5000'>
