    ...
    <div class="box">
        ...
        <div class="container"   @mouseenter.once="data.isHovered = true" @mouseleave="data.isHovered = false">
            <div class="glass" style="--r:-15;" >
                ...
                <h2>01</h2>
                <h3>测试1</h3>
                <a v-if="data.isShow1" class="but" @click="test(url1)">立即测试</a>
            ...
            <div class="glass" style="--r:5;" >
                ...
                <div class="content">
                    <h2>02</h2>
                    <h3>测试2</h3>
                    <a v-if="data.isShow2" class="but" href="#" @click="test(url2)">立即测试</a>
                    <a v-else class="disable" @click="reminder()">已作答</a>
                </div>
            </div>
            <div class="glass" style="--r:25;" >
                ...
                <div class="content">
                    <h2>03</h2>
                    <h3>测试3</h3>
                    <a v-if="data.isShow3" class="but" href="#" @click="test(url3)">立即测试</a>
                    <a v-else class="disable" @click="reminder()">已作答</a>
                </div>
            </div>
            <div class="glass" style="--r:-15;" data-text="">
                ...
                <div class="content">
                    <h2>04</h2>
                    <h3>测试4</h3>
                    <a v-if="data.isShow4" class="but" href="#" @click="test(url4)">立即测试</a>
                    <a v-else class="disable" @click="reminder()">已作答</a>
                </div>
            </div>
        </div>
