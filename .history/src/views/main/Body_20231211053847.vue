 ...
 * @LastEditTime: 2023-12-11 05:38:47
            ...
            <div class="js_nav">
                ...
                <div class="city_ul">
                    <div class="city_li">
                        ...
                        <router-link class="city_Mengde" to="/jiaose/Mengde" @click="di(1)" active-class="xuancity">算法组</router-link>
                    </div>
                    <div class="city_li">
                        <img src="../../assets/jiaosepage/done.png" alt="" class="done">
                        <img src="../../assets/jiaosepage/xuanzhong.png" class="xuanzhong" v-if="cut===2" alt="">
                        <router-link class="city_Liyue" to="/jiaose/Liyue" @click="di(2)" active-class="xuancity">项目组</router-link>
                    </div>
                </div>
            </div>
