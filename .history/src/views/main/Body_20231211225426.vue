 ...
 * @LastEditTime: 2023-12-11 22:54:26
    ...
    <div class="layout">
      ...
      <div class="content2">
        ...
        <div class="salary-comparison">
            <h1 class="backtitle-l" align="center">Salary</h1>
            <h1 class="subtitle-l flag" v-observe="'active'" align="center">薪资对比</h1>
            <p class="description-l flag" v-observe="'active'" align="center">实验室已培养了约两百余名正式成员，他们毕业后分布于各大高校和互联网公司。</p>
      ...
      <div class="content3">
        ...
        <h1 class="subtitle flag" v-observe="'active'" align="center">读研分布</h1>
        <p class="description flag" v-observe="'active'" align="center">实验室已培养了约两百余名正式成员，他们毕业后分布于各大高校和互联网公司。</p>
      ...
      <div class="content4">
        ...
        <p class="description flag" v-observe="'active'" align="center">近三届实验室成员就业升学情况</p>
