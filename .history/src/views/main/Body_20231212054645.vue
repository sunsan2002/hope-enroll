 ...
 * @LastEditTime: 2023-12-12 05:39:51
    ...
    <div class="layout">
      ...
      <div class="content5">
        ...
        <div class="container2">
            ...
            <div class="left">
                <h1 class="box-title position2 flag" v-observe="'active'">指导教师</h1>
                <p class="description describe2 flag" v-observe="'active'">2003-至今,工作于吉首大学。曾任软件学院软件工程系主任,现任软件学院工程实训中心主任.曾获张家界市优秀教师，吉首大学师德标兵,吉首大学校级骨干教师.吉首大学教学新秀。积极培训和指导学生参加国家级学科竞赛。三年来指导学生获奖共100人次，获各类奖项30多项。</p>
            </div>
        </div>
