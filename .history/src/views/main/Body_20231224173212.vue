 ...
 * @LastEditTime: 2023-12-24 17:31:38
    ...
    <div class="layout">
      ...
      <div class="content5">
        ...
        <div class="container4">
            <div class="right">
               <el-card class="box-card flag1" v-observe="'active1'">
                    <img class="photo "  src="../../assets/photo/答辩1.png"  />
                </el-card> 
            </div>
            <div class="left">
        ...
        <div class="container5">
            ...
            <div class="left">
                <el-card class="box-card flag1" v-observe="'active1'">
                    <img class="photo "  src="../../assets/photo/活动1.jpg"  />
                </el-card> 
            </div>
        </div>
      </div>
...
function getUser(){
    apiFun.user.getUser().then((res: any) => {
      console.log(res);
      //解析token
      // const decode = jwtDecode(token);
      // console.log("token解析内容", decode); //decode是一个对象
      //把解析后的token内容放进store中
      store.id = form.username;
      store.username = res.msg.name;
      store.token = res.msg.token;
      store.apply = res.msg.apply;
      store.state = true;
      if(res.code === 200){
