 ...
 * @LastEditTime: 2023-12-25 17:01:09
    ...
    <div class="layout">
      ...
      <div class="content5">
        ...
        <div class="container1">
            ...
            <p class="description describe1 flag" v-observe="'active'">创新创业工作室创立于2007年，植根于吉首大学软件学院，是吉首大学最早创立的工作室，由黄伟老师创办，旨在培养懂得感恩，有自驱力和创造力的优秀大学生。目前已培养的正式成员约两百余人，培养成员毕业分布遍布各大高校以及各大互联网行业公司。</p>
        </div>
        ...
        <div class="container4">
            ...
            <div class="left">
                ...
                <p class="description describe1 flag" v-observe="'active'">希望工作室不仅仅是一个自习的场所，更像是一个培养学习社区。在这个社区中，每个成员都有机会担任值日生，负责检查同伴是否准时到达学习场所。每周，我们会组织值日生进行集体大扫除，不仅仅是卫生清理，还包括对学习生活的整体梳理。我们工作室每周还定期召开例会和讨论会，共同回顾上周的学习和工作情况，共同制定并执行解决方案。这是我们工作室独特的特色。

在管理方面，希望工作室不仅仅是制定一些规定，更注重规定的严格执行。这也是我们工作室脱颖而出的关键原因之一。相比之下，希望工作室强调的是培养模式，通过奖惩制度来激发每个成员的学习积极性。优秀表现的成员将获得相应的奖励，而表现不佳或者缺乏上进心的成员将受到严肃的惩罚，甚至可能面临末位淘汰等措施。在这里，你将迎来一个严峻的挑战，但同时，你也将在这个培养模式下更轻松地实现自律和成长。希望工作室致力于打造一个严格而有序的学习环境，让每个成员都能够快速成长，学会独立自律。</p>
            </div>
        </div>
