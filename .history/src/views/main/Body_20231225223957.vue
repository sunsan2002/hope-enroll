 ...
 * @LastEditTime: 2023-12-25 22:37:43
            ...
            <div class="js_nav">
                ...
                <div class="city_ul">
                    <div class="city_li">
                        ...
                        <router-link class="city_Mengde" to="/main/in" @click="di(1)" active-class="xuancity">算法组</router-link>
                    </div>
                    <div class="city_li">
                        <img src="../../assets/jiaosepage/done.png" alt="" class="done">
                        <img src="../../assets/jiaosepage/xuanzhong.png" class="xuanzhong" v-if="cut===2" alt="">
                        <router-link class="city_Liyue" to="/main/arithmetic" @click="di(2)" active-class="xuancity">项目组</router-link>
                    </div>
                </div>
            </div>
