 ...
 * @LastEditTime: 2024-05-19 21:03:32
        ...
        <div class="container5">
            <div class="right">
                ...
                <p class="description describe1 flag" v-observe="'active'">
                    在学习的同时，我们注重团队的休闲与互动。定期举办丰富多彩的团建活动，不仅加深了同事间的默契，也为工作环境注入了活力。我们秉持着“每月一善”的理念，共同投入爱心，回馈社会，让我们的努力不仅造福自己，也温暖了更多的人心。为了让团队更加紧密，我们定期举办温馨快乐的生日会，共同庆祝团队成员的生日，感受大家之间的温暖。此外，我们还鼓励在学习分享会上展示自己的学习成果和心得体会，轻松而不失正式，为团队成员提供了一个共享经验和知识的平台。</p>
            </div>
            <div class="left">
                <el-card class="box-card flag1" v-observe="'active1'">
