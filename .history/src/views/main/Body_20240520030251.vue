 ...
 * @LastEditTime: 2024-05-20 03:00:50
      ...
      <div class="content1">
        <section class="wrap flag" v-observe="'active'">
            ...
            <div class="sign">
                ...
                <p class="arrow-p" style="color: #fff;">下拉了解更多</p>
            </div>
        </section>
                    ...
                    <el-col v-for="(item, index) in employmentData" :key="index" :span="6" class="layout-col" >
                        <div class="flipbox">
                            ...
                            <div class="card back">
                                ...
                                <h1 class="name" v-html="formatBackTitle(item.backTitle)"></h1>
                            </div>
                        </div>
                    </el-col>
                </el-row>
            ...
            <el-row :gutter="20" >
                <el-col v-for="(item, index) in postgraduateData" :key="index" :span="6" class="layout-col" >
                    <div class="flipbox">
                        ...
                        <div class="card back">
                            <h1 class="name">{{ item.backTitle }}</h1>
